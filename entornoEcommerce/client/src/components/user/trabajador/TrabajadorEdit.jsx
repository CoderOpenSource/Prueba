...
function TrabajadorEdit() {
  ...
  useEffect(() => {
    ...
    axios.get(`http://192.168.0.151/users/usuarios-Trabajador/${id}/`)
      .then(response => {
  ...
  const handleSubmit = async (event) => {  // <--- Añade 'async' aquí
 ...
 try {
    await axios.put(`http://192.168.0.151/users/usuarios-Trabajador/${id}/`, formData, {
      headers: {
