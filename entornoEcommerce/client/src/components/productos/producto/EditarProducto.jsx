...
function EditarProducto() {
    ...
    useEffect(() => {
        axios.get('http://192.168.0.17/productos/categorias/')
            .then(response => {
        ...
        axios.get(`http://192.168.0.17/productos/imagenesproducto/`)
            .then(response => {
        ...
        axios.get(`http://192.168.0.17/productos/productos/${id}/`)
            .then(response => {
    ...
    axios.delete(`http://192.168.0.17/productos/imagenesproducto/${imagen.id}/`)
    .then(response => {
    ...
    axios.put(`http://192.168.0.17/productos/productos/${id}/`, formData)
    .then(response => {
        if (imagenes.length) {
...
const handleUploadImages = () => {
    const requests = imagenes.map((image) => {
        ...
        return axios.post(`http://192.168.0.17/productos/imagenesproducto/`, formData, {
            headers: {
