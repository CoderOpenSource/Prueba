...
function EditarProducto() {
    ...
    useEffect(() => {
        ...
        axios.get(`http://165.227.68.145/productos/imagenesproducto/`)
            .then(response => {
        ...
        axios.get(`http://165.227.68.145/productos/productos/${id}/`)
            .then(response => {
    ...
    axios.delete(`http://165.227.68.145/productos/imagenesproducto/${imagen.id}/`)
    .then(response => {
    ...
    axios.put(`http://165.227.68.145/productos/productos/${id}/`, formData)
    .then(response => {
        if (imagenes.length) {
...
const handleUploadImages = () => {
    const requests = imagenes.map((image) => {
        ...
        return axios.post(`http://165.227.68.145/productos/imagenesproducto/`, formData, {
            headers: {
